...
# aws lambda update-function-code --region eu-west-2 --function-name delete_tile_info --image-uri "880381944355.dkr.ecr.eu-west-2.amazonaws.com/delete_tile_info:latest"
